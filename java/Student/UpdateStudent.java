...
public class UpdateStudent extends JFrame implements ActionListener {
    ...
    JButton updateStudent = new JButton("Update java.Student"), cancel = new JButton("Cancel"), select = new JButton("Select");

    public UpdateStudent(String stuNo, Conn c) {
    ...
    private void initializeFrame() {
        ...
        setTitle("Update java.Student Details");
        setResizable(false);
        setSize(775, 500);
    ...
    private void initializeLabels() {
        JLabel selectNo = new JLabel("Select by java.Student Number");
        ...
        try {
            ResultSet rs = conn.stmt.executeQuery("SELECT studentNo FROM student");
            while(rs.next()) {
        ...
        JLabel txtNumber = new JLabel("java.Student Number");
    ...
    private void changeLabels(String stuNo) {
        try {
            cStuNum.select(stuNo);
            String query = "SELECT * FROM student WHERE studentNo = '" + stuNo + "'";
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == updateStudent) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "java.Student details updated successfully");
            ...
            this.stuNo = cStuNum.getSelectedItem();
