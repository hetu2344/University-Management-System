...
public class AddStudentInfo extends JFrame implements ActionListener {
    ...
    JLabel lblSNumber;
    JButton addStudent = new JButton("Add java.Student"), cancel = new JButton("Cancel"), clear = new JButton("Clear");
    static JDateChooser dtDob;
    JComboBox txtFaculty;

    public AddStudentInfo(Conn c) {
        ...
        JLabel heading = new JLabel("New java.Student Details");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == addStudent) {
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "java.Student details added successfully");
